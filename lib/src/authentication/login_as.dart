      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 30.0),
            _buildLoginButton(LANGUAGE=="ENGLISH"?'Login as Company':"تسجيل الدخول كشركة", Colors.black.withOpacity(0.7), CommonLogin(isCompany: true,)),
            const SizedBox(height: 20.0),
            _buildLoginButton(LANGUAGE=="ENGLISH"?'Login as Student':"تسجيل الدخول كطالب", Colors.black.withOpacity(0.7), CommonLogin()),
          ],
        ),
      ),
    );
