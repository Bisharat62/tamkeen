...
class _StudentDetailsScreenState extends State<StudentDetailsScreen> {
  ...
  getdetails() async {
    try {
      var res = await api.StudentDetailsNetwork(widget.student_id);
      print("res $res");
      if (res['codeStatus'] == true) {
        ...
        _skillsController.text = res['data']['skills_and_experience'] ?? "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Appbar(
        title: LANGUAGE == 'ENGLISH' ? "Trainee Details" : "تفاصيل المتدرب",
        back: true,
      ),
      body: isLoading
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'First Name' : 'الاسم الأول',
                        _firstNameController.text),
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'Last Name' : 'اسم العائلة',
                        _lastNameController.text),
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'Email' : 'بريد إلكتروني',
                    ...
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'University' : 'جامعة',
                        _universityController.text),
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'Major' : 'رئيسي',
                        _majorController.text),
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'Degree Level' : 'مستوى الدرجة',
                        _degreelevelController.text),
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH'
                            ? 'Date Of Joining'
                    ...
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'DOB' : 'تاريخ الميلاد',
                        _dobController.text),
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'Country' : 'دولة',
                        _countryController.text),
                    rowViewCard(
                        context,
                        LANGUAGE == 'ENGLISH' ? 'City' : 'مدينة',
